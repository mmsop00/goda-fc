...
async function main() {
  ...
  const newsItems = [
    ...
    { slug: "tong-ket-giai-tu-hung-ky-niem-32-nam-thanh-lap-clb-goda", title: "Tổng kết Giải tứ hùng kỷ niệm 32 năm thành lập CLB GODA: FFC vô địch", summary: "FFC vô địch với 9 điểm tuyệt đối, GODA FC giành ngôi Á quân. Tổng hợp kết quả 06 trận đấu, giải chạy 100m và thu chi buổi sinh nhật lần thứ 32.", content: "Tổng kết giải đấu:\n\n- Vô địch: FFC (9 điểm, hiệu số +4)\n- Á quân: GODA FC (4 điểm, hiệu số 0)\n- Hạng Ba: Việt Nhật FC (4 điểm, hiệu số -1)\n- Hạng Tư: Motor FC (0 điểm)\n\nGiải chạy 100m: nhóm dưới U40 — Phan Văn Đức (FFC) vô địch; nhóm U60 trở lên — Trần Tiến Dũng (GODA FC) vô địch.\n\nTổng hợp thu chi: thành viên GODA 96.000.000đ + khách mời và các đội bạn 31.500.000đ = 127.500.000đ. Tổng chi: 102.340.000đ. Kết dư: 25.160.000đ.\n\nChưa hoàn thành đóng tiền: Tuấn (Trâu Đồ Sơn), Anh Huy, Anh Đức Anh.\n\nTrân trọng cảm ơn tất cả mọi người đã giúp GODA FC tổ chức thành công buổi sinh nhật lần thứ 32!", date: "07/09/2026", category: "Giải đấu" },
  ];
