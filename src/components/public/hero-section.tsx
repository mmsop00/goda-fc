...
export function HeroSection() {
  return (
    <section className="relative">
      ...
      <div className="relative w-full h-[40vh] min-h-[280px] sm:h-[70vh] sm:min-h-[420px] max-h-[720px]">
        <Image
          src={HERO_PHOTO}
          alt="GODA FC"
          fill
        ...
        {/* Hero text content — centered on desktop only */}
        <div className="absolute inset-0 hidden sm:flex flex-col items-center justify-center text-center px-4">
