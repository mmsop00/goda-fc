...
export const MOCK_MATCH_RESULTS: MatchResult[] = [
  ...
  },
  {
    ...
    goals: [],
    cards: [],
    imageUrl: "https://placehold.co/800x400/0B1E3A/F7C600?text=GODA+VS+B%E1%BA%AFc+Vi%E1%BB%87t+FC",
    googleMapsUrl: "https://maps.app.goo.gl/dwVAQCR4ZAVYtkFD9",
  },
  {
    id: "mr-008",
