...
export const MOCK_MEMBERS: MemberPublic[] = [
  ...
  { id: "m-007", name: "Nguyễn Tiến Dũng", nickname: "Tiến Dũng", position: "Tiền vệ", number: 11, avatarUrl: "", matches: 45, goals: 1, assists: 6, mvp: 10, birthday: "25/06", joinYear: 0, status: "Đang thi đấu" },
